...
//! EMAIL, TEL, ADR, LABEL, ORG, TITLE, ROLE, NOTE, BDAY, URL, PHOTO, CATEGORIES
...
pub use contact::{
    ...
    states_address, states_anniversary, states_email, states_keyword, states_link, states_media,
