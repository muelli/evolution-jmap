...
pub use contact::{
    ...
    states_a_point_in_time, states_address, states_anniversary, states_email, states_keyword,
    states_link, states_media, states_nickname, states_note, states_online_service,
