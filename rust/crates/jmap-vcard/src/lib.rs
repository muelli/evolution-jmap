...
pub use contact::{
    ...
    restore_address_components, restore_name_components, same_service, states_a_point_in_time,
    states_address, states_anniversary, states_email, states_keyword, states_link, states_nickname,
