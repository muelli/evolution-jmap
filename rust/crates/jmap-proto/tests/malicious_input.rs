...
proptest! {
    ...
    #[cfg(feature = "mail")]
    #[test]
    fn arbitrary_json_never_panics_deserializing_vacation_response_capability(value in json_value()) {
        let text = value.to_string();
        let _ = serde_json::from_str::<jmap_proto::mail::VacationResponseCapability>(&text);
    }
}
