...
use eds_sys::{
    ...
    camel_folder_error_quark, camel_folder_get_folder_summary, camel_folder_refresh_info_sync,
    camel_folder_summary_get, camel_folder_transfer_messages_to_sync, camel_message_info_set_flags,
