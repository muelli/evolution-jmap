...
field edit" question is confirmed **no** — a genuine gap, now open as its
own item pending a session that can give new GObject signal-connection FFI
work the correctness attention that class of change needs.
